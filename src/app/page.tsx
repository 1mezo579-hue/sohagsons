...
export default function Home() {
  const modules = [
    { title: "الكاشير", icon: ShoppingCart, href: "/cashier", bg: "bg-blue-600", text: "text-blue-600" },
    { title: "المخزن", icon: Package, href: "/inventory", bg: "bg-emerald-500", text: "text-emerald-600" },
    { title: "التقارير", icon: BarChart3, href: "/reports", bg: "bg-amber-500", text: "text-amber-600" },
    { title: "الإعدادات", icon: Users, href: "/users", bg: "bg-rose-500", text: "text-rose-600" },
  ];
